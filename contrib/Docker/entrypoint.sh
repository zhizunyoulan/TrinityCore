...
DIST_DIR="${DIST_DIR:-/trinity/dist}"
CONF_DIR="${CONF_DIR:-/trinity/dist/etc}"
...
cp -rnv /trinity/ref/etc/* "$CONF_DIR"

CONF="$CONF_DIR/$trinity_COMPONENT.conf"
CONF_DIST="/trinity/ref/etc/$trinity_COMPONENT.conf.dist"
...
echo "Starting $trinity_COMPONENT..."
